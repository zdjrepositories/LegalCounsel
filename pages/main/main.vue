	...
	<view class="page_edu">
		<view class="page_edu_header">
			...
			<view class="header_content">
				<view class="left">
					<text class="title">甘肃省乡村法律顾问</text>
					<text class="sub_title">老百姓的法律顾问掌中宝</text>
...
<style lang="scss" scoped>
	...
	.page_edu_header {
		...
		width: 100%;
		height: realSize(380px);

		.header {
			display: flex;
			flex-direction: row;
			align-items: center;
			padding-left: realSize(20px);
			padding-right: realSize(20px);
			margin-top: -32px;
			.btn {
				width: realSize(36px);
